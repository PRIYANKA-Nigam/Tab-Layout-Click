...
public class PaymentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        public void onClick(View v) { String name=e1.getText().toString();String upiId=e2.getText().toString();String amt=e3.getText().toString();
            ...
            if (name.isEmpty()||upiId.isEmpty()){ Toast.makeText(PaymentActivity.this,"Name & UPI ID is necessary",Toast.LENGTH_SHORT).show();
            }else { PayUsingUPI(name,upiId,amt,msg); } }}); }private  void PayUsingUPI(String name,String upiId,String amt,String msg){
        ...
        }else { Toast.makeText(this,"No UPI app found",Toast.LENGTH_SHORT).show(); }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) { super.onActivityResult(requestCode, resultCode, data);
        if (requestCode==PAY_REQUEST){ if (isInternetAvailable(PaymentActivity.this)){
